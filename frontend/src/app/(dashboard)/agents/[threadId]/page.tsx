...
export default function ThreadPage({
  ...
  useEffect(() => {
    if (initialLoadCompleted.current && subscriptionData) {
      const hasSeenUpgradeDialog = localStorage.getItem('ryxen_upgrade_dialog_displayed');
  ...
  const handleDismissUpgradeDialog = () => {
    ...
    localStorage.setItem('ryxen_upgrade_dialog_displayed', 'true');
  };
          ...
          <DialogContent onPointerDownOutside={(e) => e.preventDefault()} className="sm:max-w-md">
            <DialogHeader>
              <DialogTitle className="flex items-center">
                ...
                Unlock the Full Ryxen Experience
              </DialogTitle>
              <DialogDescription>
                You're currently using Ryxen's free tier with limited capabilities.
