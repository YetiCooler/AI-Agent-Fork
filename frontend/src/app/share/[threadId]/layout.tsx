...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Ryxen',
    description: 'Replay this Agent conversation on Ryxen',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Ryxen';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Ryxen';
