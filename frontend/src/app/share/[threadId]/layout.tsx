...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Kortix Ryxen',
    description: 'Replay this Agent conversation on Kortix Ryxen',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Kortix Ryxen';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Kortix Ryxen';
