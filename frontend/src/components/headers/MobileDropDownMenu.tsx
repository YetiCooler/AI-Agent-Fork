  ...
  return (
    <DropdownMenu onOpenChange={setIsOpen} open={isOpen}>
      <DropdownMenuTrigger className="bg-transparent border-none focus:outline-none hover:bg-transparent hover:outline-none p-0">
        <ShadowBtn
          className="rounded-md md:hidden z-50"
          mainClassName="rounded-md border-[#2C2B30] border bg-[#292929] shadow-btn-google text-white p-2 flex items-center justify-center gap-2 cursor-pointer"
        >
          {
            isOpen ?
              <X size={18} /> :
      ...
      <DropdownMenuContent
        className="bg-[#0D0D0D] sm:mt-[14px] sm:w-[200px] w-screen max-sm:h-screen border-secondaryBorder -mt-[67px] relative"
        align="end"
      >
        <ShadowBtn
          className="rounded-md md:hidden absolute top-6 right-3"
          mainClassName="rounded-md border-[#2C2B30] border bg-[#292929] shadow-btn-google text-white p-2 flex items-center justify-center gap-2 cursor-pointer"
