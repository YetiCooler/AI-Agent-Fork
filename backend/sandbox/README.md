...
2. Build a custom image:
   ...
   docker push kortix/ryxen:0.1.2
   ```
...
1. Change the `image` parameter in `docker-compose.yml` (that defines the image name `kortix/ryxen:___`)
...
3. Push the new version: `docker push kortix/ryxen:0.1.3`
